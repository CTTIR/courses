---
title: "Week 1, Session 2 — Simple linear regression"
...
format:
  html:
    ...
    code-tools: true
  revealjs:
    output-file: "lab_week1_session2_slides.html"
...
Session 1 of this week; basic comfort with ggplot2.
...
> Among Adelie penguins (*n* = `r nrow(ad)`), each additional mm of
> bill length was associated with an increase of
> `r round(slope, 0)` g in body mass (95% CI:
> `r round(ci[1], 0)` to `r round(ci[2], 0)` g;
> *p* = `r signif(glance(fit)$p.value, 2)`). Bill length explained
> `r round(100 * glance(fit)$r.squared, 1)`% of the variance in body
> mass.

::: {.notes}
Point out that R² below 30% is common and fine; the estimate is the
story, not the variance explained.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 102dd4abd467448aa9cc2133853d2d87 -->
<img src="https://vg09.met.vgwort.de/na/102dd4abd467448aa9cc2133853d2d87"
