---
title: "Week 4, Session 3 — Survival primer: KM, log-rank, Cox PH"
...
> sex (HR `r round(hr_row$estimate, 2)`; 95% CI
> `r round(hr_row$conf.low, 2)` to `r round(hr_row$conf.high, 2)`;
> *p* = `r signif(hr_row$p.value, 2)`), adjusted for age. The
> proportional-hazards assumption was not clearly violated
> (Schoenfeld test, all *p* > 0.05).

::: {.notes}
Emphasise the difference between a median survival comparison (which
requires enough events) and a Cox model (which uses every event time).
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 109e8b9f7b1c4aa7b2d5a3dc651a2cb9 -->
<img src="https://vg09.met.vgwort.de/na/109e8b9f7b1c4aa7b2d5a3dc651a2cb9"
