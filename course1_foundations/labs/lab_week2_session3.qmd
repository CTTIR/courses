---
title: "Week 2, Session 3 — Diagnostic testing: Se, Sp, PPV, NPV, LR"
...
format:
  html:
    ...
    code-tools: true
  revealjs:
    output-file: "lab_week2_session3_slides.html"
...
> With a cutoff of `r cutoff`, the biomarker had sensitivity
> `r round(sens, 2)`, specificity `r round(spec, 2)`, PPV
> `r round(ppv, 2)`, and NPV `r round(npv, 2)`. The positive
> likelihood ratio was `r round(lrp, 2)` and the negative
> `r round(lrn, 2)`. A pre-test probability of 10% becomes
> `r round(post_prob_pos, 2)` after a positive test and
> `r round(post_prob_neg, 3)` after a negative test.
...
::: {.notes}
Walk through the ROC construction cut-by-cut. Emphasise that no point
on the curve is the "right" one — the right one depends on the
relative cost of a false positive vs. a false negative.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 0fb5cc4a8916448186c7b8989ce4ad8a -->
<img src="https://vg09.met.vgwort.de/na/0fb5cc4a8916448186c7b8989ce4ad8a"
