---
title: "Week 4, Session 3 — Pearson and Spearman correlation"
...
format:
  html:
    ...
    code-tools: true
  revealjs:
    output-file: "lab_week4_session3_slides.html"
...
> `r round(p1_pearson$estimate, 2)` (*p* =
> `r signif(p1_pearson$p.value, 2)`) and Spearman
> ρ = `r round(p1_spearman$estimate, 2)`; the two agreed. In the
> monotonic non-linear case, Pearson *r* =
> `r round(p2_pearson$estimate, 2)` was substantially smaller
> than Spearman ρ = `r round(p2_spearman$estimate, 2)`, revealing
...
::: {.notes}
Show the DatasauRus grid large and silent for ten seconds — the
visual impact makes the point that no verbal argument can.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 0ff85ff8c92946258b61f02a17528e85 -->
<img src="https://vg09.met.vgwort.de/na/0ff85ff8c92946258b61f02a17528e85"
