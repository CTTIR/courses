---
title: "Week 2, Session 5 — tidymodels pipelines"
...
CV and regularisation from Week 1.
...
```{r}
roc_curve(preds, truth = type, .pred_Yes, event_level = "second") |>
  autoplot()
```
...
> `r round(roc_auc(preds, truth = type, .pred_Yes, event_level = "second")$.estimate, 3)`
> on `MASS::Pima.tr`.
...
::: {.notes}
Show `last_fit()` as a one-liner for the finalise-then-evaluate step
if time.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 1199a148b9424ae080bfd9aaab9e176c -->
<img src="https://vg09.met.vgwort.de/na/1199a148b9424ae080bfd9aaab9e176c"
