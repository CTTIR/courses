---
title: "Week 3, Session 3 — Biomarker statistics (Youden, NRI, decision curves)"
...
> `r round(as.numeric(auc(r)), 3)`. The Youden-optimal cut-point
> occurred at a predicted probability of
> `r round(coords(r, "best", ret = "threshold", transpose = FALSE)[1, 1], 2)`.
> Adding BMI and age to a glucose-only baseline produced an NRI of
> `r round(nri, 2)`; the decision curve showed net benefit above
...
::: {.notes}
If time, show bootstrap CIs for AUC with `pROC::ci.auc` and for net
benefit with resampling.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 11abba50d6c64547974e7c77c4033fa0 -->
<img src="https://vg09.met.vgwort.de/na/11abba50d6c64547974e7c77c4033fa0"
