---
title: "Week 1, Session 5 — UMAP and t-SNE"
...
format:
  html:
    ...
    code-tools: true
  revealjs:
    output-file: "lab_week1_session5_slides.html"
...
::: {.notes}
If time, show that shuffling point identities within a blob leaves
the UMAP essentially unchanged; the picture is about neighbour
structure, not exchangeable labels.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 118d492e58f24a04b38d722386d8ff49 -->
<img src="https://vg09.met.vgwort.de/na/118d492e58f24a04b38d722386d8ff49"
