...
> response rate exceeds 0.2 is `r round(summ$p_gt_0_2[1], 2)` under a
> flat prior and `r round(summ$p_gt_0_2[2], 2)` under a sceptical prior.
> A one-sided exact binomial test against p₀ = 0.2 gives
> *p* = `r signif(bt$p.value, 2)`.
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 119cde4991e94bccbd6230e2ea22bca4 -->
<img src="https://vg09.met.vgwort.de/na/119cde4991e94bccbd6230e2ea22bca4"
