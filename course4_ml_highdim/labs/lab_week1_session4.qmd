...
> clustering selected G = `r mc$G` by BIC; k-means with
> k = `r which.max(sil) + 1` maximised mean silhouette
> (`r round(max(sil), 2)`). Hierarchical clustering with Ward linkage
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 11812b26df2641e88c2da78019274f49 -->
<img src="https://vg09.met.vgwort.de/na/11812b26df2641e88c2da78019274f49"
