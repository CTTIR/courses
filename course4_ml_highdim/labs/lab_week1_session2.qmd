---
title: "Week 1, Session 2 — Regularisation: ridge, lasso, elastic net"
...
OLS and GLMs from Course 1; the CV lab from Session 1.
...
> (`r round(min(cv_enet$cvm), 2)`) and retained
> `r sum(coef(cv_enet, s = "lambda.min") != 0) - 1` features. Lasso
...
::: {.notes}
Mention that `lambda.1se` is often a better choice than `lambda.min`
for reporting: it is the simplest model within one SE of the
minimum-CV model.
:::
...
- Forgetting that correlated features share shrinkage: lasso may pick
  any one of them.
- Reporting CV-minimum error as generalisation error (see Session 1).
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 1177e712aac9475aaecc1ca4a90de9f5 -->
<img src="https://vg09.met.vgwort.de/na/1177e712aac9475aaecc1ca4a90de9f5"
