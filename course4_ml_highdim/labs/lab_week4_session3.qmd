---
title: "Week 4, Session 3 — scRNA-seq with Seurat"
...
```{r}
table(cluster = km$cluster, truth = cell_type)
```
...
::: {.notes}
Mention that `Harmony` or `scVI` are the usual choices for batch
integration; clustering on uncorrected data across batches is a
classic mistake.
:::
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 11df628d9d264af5a675c1a23277378e -->
<img src="https://vg09.met.vgwort.de/na/11df628d9d264af5a675c1a23277378e"
