...
format:
  html:
    ...
    code-tools: true
  revealjs:
    output-file: "lab_week4_session2_slides.html"
...
> Across `r nrow(dat)` trials of the BCG vaccine, the pooled risk ratio
> for tuberculosis was `r round(rr, 2)` (95% CI `r round(lo, 2)` to
> `r round(hi, 2)`; τ² = `r round(fit$tau2, 2)`, I² =
> `r round(fit$I2, 1)`%). Between-trial heterogeneity was substantial;
...
::: {.vgwort-pixel}
```{=html}
<!-- VG Wort Zählmarke — public ID: 111c6f90032747609bfc99224c3eb786 -->
<img src="https://vg09.met.vgwort.de/na/111c6f90032747609bfc99224c3eb786"
